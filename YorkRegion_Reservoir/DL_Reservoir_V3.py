...
facility_name = 'South Richmond Hill Reservoir'
file_name = 'SRHR_InstalledYear'
file_name += '.xlsx'
sheet_name = 'Sheet1'
...
for index, AssetInput in df_Cleaned.iterrows():
    ...
    AssetDefect1_Input = AssetInput['defect1']
    AssetDefect2_Input = AssetInput['defect2']
    AssetDefect3_Input = AssetInput['defect3']
    AssetRecommendation1_Input = ''
    AssetRecommendation2_Input = ''
    AssetRehab1Cost_Output = 0
    AssetRehab2Cost_Output = 0
